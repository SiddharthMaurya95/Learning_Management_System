...
function TopicInput({setTopic,setAbout}) {
  return (
    <div>
        <h2 className='mt-5 text-center'>Write the topic for which you want to generate a course(eg., Python Course, Yoga, etc)</h2>
        <Textarea placeholder='Start writing here' 
        onChange={(event)=>setTopic(event.target.value)} className='mt-2' required></Textarea>

        <h2 className='mt-5 text-center'>Tell us more about your course, what you want to include in this course</h2>
